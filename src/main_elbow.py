...
"""
acc without taking into account no pred cell 0.8352
acc with taking into account no pred cell 0.8338
% of predicted 0.9982502187226596
mean iou 0.6558
mean prc_not_catch_list 0.2851
mean error_list 0.08526416479150864
median iou 0.7821
median prc_not_catch_list 0.1295
median error_list 0.0307
mean aji nan
acc without taking into account no pred cell 0.8352
Namespace(convex_hull=False, eps_min_weight=0, host='127.0.0.1', k_nearest_neighbors=10, max_cell_diameter=30, mean_cell_diameter=10, mode='client', path_centroid='/home/tom/Bureau/phd/simulation/mycode/centroid/', path_dataset_folder='/media/tom/T7/regular_grid/simu1912/elbow_cube/dataframe_max3/', path_dict_cell_centroid='/media/tom/T7/regular_grid/simu1912/elbow_cube/remove20/dico_centroid/', path_save='/media/tom/T7/regular_grid/simu1912/elbow_cube/dataframe_max3/results/10_d29_h12_min59_s24_r4460/', path_simulation_gr='/media/tom/T7/regular_grid/simu1912/elbow_cube/dico_simulation_nsforest0_thalassa/', path_to_mask_prior='/media/tom/T7/regular_grid/simu1912/elbow_cube/remove20/nuclei/', port='39753', weight_mode='original')
"""
